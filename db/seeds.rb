gold = User.create(email: ENV['GOLD_EMAIL'], full_name: 'Gold Bank', password: '12345!Aa')
...
user1 = User.create(email: 'user1@test.com',full_name: 'User 1', password: '12345!Aa')
Account.create(user: user1)

user2 = User.create(email: 'user2@test.com',full_name: 'User 2', password: '12345!Aa')
